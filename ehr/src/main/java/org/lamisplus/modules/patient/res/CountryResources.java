...
import org.lamisplus.modules.patient.service.CountryServices;
...
public class CountryResources {
    ...
    public CountryResources(CountriesRepository countryRepository, CountryServices countryServices) {
