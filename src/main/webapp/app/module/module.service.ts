...
export class ModuleService {
	...
	public installModule(module: Module) {
		return this.http.post<Module>(SERVER_API_URL + 'api/modules/install?install=true', module, {observe: 'response'});
	}

	public activateModule(module: Module) {
		return this.http.post<Module>(SERVER_API_URL + 'api/modules/activate', module, {observe: 'response'});
	}

	public deactivateModule(module: Module) {
		return this.http.post<Module>(SERVER_API_URL + 'api/modules/deactivate', module, {observe: 'response'});
	}

	public updateModule(module: Module) {
		return this.http.put<Module>(SERVER_API_URL + 'api/modules', module, {observe: 'response'});
	}

	public deleteModule(module: Module) {
		return this.http.post<Module>(SERVER_API_URL + `api/modules/uninstall`, module, {observe: 'response'});
	}

	public getModule(id: number) {
		return this.http.get<Module>(SERVER_API_URL + `api/modules/${id}`, {observe: 'body'});
	}
}
