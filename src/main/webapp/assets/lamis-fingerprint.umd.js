(function (global, factory) {
...
}(this, (function (exports,i1,rxjs,operators,SockJs,Stomp,i0,material,flexLayout,common,ng2Stompjs,platformBrowser,router) { 'use strict';
    ...
    var PatientService = /** @class */ (function () {
        ...
        /** @nocollapse */ PatientService.ngInjectableDef = i0.defineInjectable({ factory: function PatientService_Factory() { return new PatientService(i0.inject(i1.HttpClient)); }, token: PatientService, providedIn: "root" });
    ...
    var EventManager = /** @class */ (function () {
        ...
        /** @nocollapse */ EventManager.ngInjectableDef = i0.defineInjectable({ factory: function EventManager_Factory() { return new EventManager(); }, token: EventManager, providedIn: "root" });
        return EventManager;
    }());
    ...
    var WindowRef = /** @class */ (function () {
        ...
        /** @nocollapse */ WindowRef.ngInjectableDef = i0.defineInjectable({ factory: function WindowRef_Factory() { return new WindowRef(i0.inject(EventManager)); }, token: WindowRef, providedIn: "root" });
        return WindowRef;
    }());
    ...
    var WebsocketService = /** @class */ (function () {
        ...
        /** @nocollapse */ WebsocketService.ngInjectableDef = i0.defineInjectable({ factory: function WebsocketService_Factory() { return new WebsocketService(i0.inject(WindowRef)); }, token: WebsocketService, providedIn: "root" });
    ...
    var FingerprintComponent = /** @class */ (function () {
         ...
         */
            function () {
                var _this = this;
                this.patientService.getPatients().subscribe(function (res) { return _this.patients = res; });
    ...
    var RxStompConfig = {
        // Which server?
        brokerURL: "" + source,
        webSocketFactory: function () { return new SockJS("" + source); },
        // Headers
